function check() { // function called when Get Results! button fired
    ...
    var totalArea = parseFloat(document.quiz.totalArea.value.replaceAll(',', '')); //area of total property
    var totalImpervious = parseFloat(document.quiz.totalImpervious.value.replaceAll(',', '')); // area land
    var areaPermanent = parseFloat(document.quiz.areaPermanent.value.replaceAll(',', '')); // roof area
...
function openPopup() {
    ...
    popup.style.toggle("visibility: show");
}
